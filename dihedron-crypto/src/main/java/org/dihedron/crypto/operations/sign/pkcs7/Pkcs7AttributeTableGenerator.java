...
import org.dihedron.crypto.certificates.CertificateUtils;
	...
	public AttributeTable getAttributes(Map parameters) throws CMSAttributeTableGenerationException {
		...
		try {
	        ...
	        if(!table.containsKey(SignedData.id_aa_signingCertificate) && !table.containsKey(SignedData.id_aa_signingCertificateV2)) {
	        	...
	        	IssuerSerial issuerSerial = CertificateUtils.makeIssuerSerial(x509certificate);
	        	...
	        	case SHA1:
	        		...
	        		ESSCertID essCertId = CertificateUtils.makeESSCertIdV1(x509certificate, issuerSerial, digestAlgorithm);
	        	...
	        	case SHA512:
	        		...
	        		ESSCertIDv2 essCertIdv2s[] = CertificateUtils.makeESSCertIdV2(x509certificate, issuerSerial, digestAlgorithm); 
