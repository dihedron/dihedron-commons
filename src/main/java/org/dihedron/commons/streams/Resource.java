...
public final class Resource {
	 ...
	 * @throws IOException 
	 */
	public static InputStream getAsStreamFromFileSystem(String path) throws IOException {		
	 ...
	 * @throws IOException 
	 */
	public static InputStream getAsStreamFromFileSystem(File file) throws IOException {
