 ...
 */
@License
public class SynchronousBus<M> extends Bus<M> implements AutoCloseable {
	
	/**
	 * The logger.
	 */
	private final static Logger logger = LoggerFactory.getLogger(SynchronousBus.class);
	 ...
	 */
	public SynchronousBus(BlockingQueue<M> queue) {
		this.queue = queue;
	}
